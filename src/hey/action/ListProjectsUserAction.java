...
public class ListProjectsUserAction extends ActionSupport implements SessionAware {
	...
	public String execute() throws RemoteException {
		...
		if((projectslist=user.consultarProjetos()) != "") {
			session.put("userprojectslist", projectslist);
			return SUCCESS;
		}
		else
			return ERROR;
