...
public class ListRewardsUserAction extends ActionSupport implements SessionAware {
	private static final long serialVersionUID = 4L;
	private Map<String, Object> session;
	private String username = null, password = null;
	String userrewardslist;
	
	@Override
	public String execute() throws RemoteException {
		HeyBean user = this.getHeyBean();
		if((userrewardslist=user.consultarRecompensas()) != "") {
			session.put("userrewardslist", userrewardslist);
			return SUCCESS;
		}
		else
			return ERROR;
	...
	public String getUserrewardslist() {
		return userrewardslist;
	}

	public void setUserrewardslist(String userrewardslist) {
